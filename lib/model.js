...
_.extend(BookshelfModel.prototype, {
  ...
  save: Promise.method(function(key, val, options) {
    ...
    return Promise.bind(this).then(function() {
      ...
      .bind(this)
      .then(function() {
        if (method === 'update' && !options.patch && _.isEmpty(this.changed)) {
          return Promise.resolve(1); // Number of affected rows
        }
        return sync[options.method](method === 'update' && options.patch ? attrs : this.changed);
      })
      .then(function(resp) {
